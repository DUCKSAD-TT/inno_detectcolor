...
class HardwareNode:
    def __init__(self, root: ctk.CTk):
        ...
        self.use_ease       = True
        self.sweep_tick     = 0.002    # Default sweep tick time (0.002s = 2ms)
        self.kp             = 0.35     # เพิ่มความเร็วในการตอบสนองชะลอตัวช่วงปลาย (Ease)
        self.min_step       = 1.2      # เพิ่มขนาดก้าวขั้นต่ำสุดเพื่อให้เข้าพิกัดปลายทางได้รวดเร็วขึ้นมาก
